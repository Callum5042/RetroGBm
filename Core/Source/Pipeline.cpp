...
void Pipeline::PushPixelToVideoBuffer()
{
...
void Pipeline::FetchTileData(FetchTileByte tile_byte)
{
...
void Pipeline::LoadSpriteData(FetchTileByte tile_byte)
{
...
bool Pipeline::PipelineAddPixel()
{
...
uint32_t Pipeline::FetchSpritePixels(uint32_t color, bool background_pixel_transparent)
{
	for (int i = 0; i < m_Context.fetched_entries.size(); i++)
	{
...
bool Pipeline::IsWindowInView(int pixel_x)
{
