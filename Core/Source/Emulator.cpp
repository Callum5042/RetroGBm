...
std::string Emulator::Execute(const uint8_t opcode)
{
	switch (opcode)
	{
		...
		case 0x2F:
			return Op::ComplementA(&m_Context);
		case 0x30:
			return Op::JumpRelativeFlagNotSet(&m_Context, CpuFlag::Carry);
		case 0x31:
		...
		case 0xB7:
			return Op::OrR8(&m_Context, RegisterType8::REG_A);
		case 0xB8:
		...
		case 0xCE:
			return Op::AddCarryN8(&m_Context);
		case 0xCF:
			return Op::Rst(&m_Context, 0x08);
		case 0xD0:
		...
		case 0xF7:
			return Op::Rst(&m_Context, 0x30);
		case 0xF8:
			return Op::LoadHLFromSPRelative(&m_Context);
		case 0xF9:
